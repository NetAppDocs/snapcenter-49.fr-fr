...
+
Vous pouvez créer une stratégie en sélectionnant image:../media/add_policy_from_resourcegroup.gif["ajouter une stratégie à partir d'un groupe de ressources"] pour lancer l'assistant de stratégie.
...
.. Sélectionnez la stratégie pour laquelle vous souhaitez configurer votre planification de vérification, puis sélectionnez image:../media/add_policy_from_resourcegroup.gif["ajouter une stratégie à partir d'un groupe de ressources"].
